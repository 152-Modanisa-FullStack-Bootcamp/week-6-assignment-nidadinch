...
func TestGetAllWallets(t *testing.T) {
	t.Run("should return all wallets correctly", func(t *testing.T) {
		tests := []struct {
			name    string
			d       *data.Data
			want    []*data.Wallet
	...
	t.Run("should return empty wallet if inMemoryDB is empty", func(t *testing.T) {
		tests := []struct {
			name    string
			d       *data.Data
			want    []*data.Wallet
...
func TestGetWallet(t *testing.T) {
	t.Run("should return wallet by username", func(t *testing.T) {
		tests := []struct {
			name     string
			d        *data.Data
			username string
	...
	t.Run("should return empty wallet if wallet doesn't exist", func(t *testing.T) {
		tests := []struct {
			name     string
			d        *data.Data
			username string
